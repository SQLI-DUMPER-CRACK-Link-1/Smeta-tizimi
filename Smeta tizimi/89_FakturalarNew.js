  ...
  try {
    ...
    if (!sh) {
      ...
      var sarlavhalar = [
        ...
        "Fayl URL", "Katalog nomi", "Aksiz summasi", "NDS stavkasi", "Bank hisob raqami", "Yetkazib berish kompaniyasi"
      ];
    ...
    for (var i = 0; i < fakturalarArray.length; i++) {
      ...
      qatorlar.push([
        ...
        item.aksizSummasi || 0,
        item.ndsStavkasi || 0,
        item.yetkazibBeruvchiHisobRaqam || "",
        item.yetkazibBerishKompaniyasi || ""
      ]);
    }
