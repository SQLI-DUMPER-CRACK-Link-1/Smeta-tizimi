...
export interface CenterDocument { id: string; filename: string; type: string; revision: number; mime: string; size: number; sha256: string; canonicalStatus: DocumentStatus; updatedAt: string; createdAt: string; author: string; replicas: DocumentReplica[]; }
