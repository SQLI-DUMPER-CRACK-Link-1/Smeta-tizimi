...
const KATEGORIYALAR = ['МАТ', 'ОБ', 'М/К', 'КАБ', 'БЕЗСКЛАД'];
const QULF = ['ЧЕЛ', 'МАШ'];

const KAT_RANG: Record<string, 'ok' | 'warn' | 'danger' | 'neytral'> = {
  'ЧЕЛ': 'neytral', 'МАШ': 'neytral', 'МАТ': 'ok', 'ОБ': 'warn', 'КАБ': 'neytral', 'М/К': 'neytral', 'БЕЗСКЛАД': 'neytral',
};
    ...
    <Sahifa
      ...
      amallar={
        <div className="flex items-center gap-3">
          <Tanlov qiymat={filter} ozgardi={setFilter} variantlar={['ALL', 'ЧЕЛ', 'МАШ', 'МАТ', 'ОБ', 'КАБ', 'М/К', 'БЕЗСКЛАД']} />
                          ...
                          <td className="py-1 px-2">
                            {orTahrir ? (
                              <select value={o.kat}
                                ...
                                {['ЧЕЛ', 'МАШ', 'МАТ', 'ОБ', 'КАБ', 'М/К', 'БЕЗСКЛАД'].map((k) =>
