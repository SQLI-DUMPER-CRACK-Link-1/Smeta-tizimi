...
export default function F2NavbatChip() {
  ...
  return (
    <div className={`fixed bottom-4 right-4 z-[60] w-[330px] rounded-xl border shadow-2xl
      ...
      {!yigilgan && (
        <div className="px-3 py-2 space-y-1.5">
          ...
          {/* ⚠ QOTGAN ISH — chiqish yo'li. Avval bu imkoniyat yo'q edi. */}
          {qotdi && (
            <div className="rounded-lg border border-danger/40 bg-danger/10 p-2">
              ...
              <button
                ...
                className="w-full px-2 py-1 rounded bg-danger/20 hover:bg-danger/30
                           text-danger text-[11px] font-medium transition-colors disabled:opacity-50">
