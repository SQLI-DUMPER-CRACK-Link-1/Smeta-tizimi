...
console.log('\n── 1. YOZISH ESHIGI TOR QOLGANMI ──');
{
     ...
     Ya'ni yangi amal qo'shish = shu faylga ataylab kod yozish. */
  {
    ...
    const KUTILGAN = ['t2_akt_bekor', 't2_akt_tasdiqlash', 't2_akt_yarat',
                      ...
                      't2_qator_qosh', 't2_qator_tahrir', 't2_shaxsiy_smeta_yarat', 't2_skladga_yozish', 't2_erp_amal', 't2_boss_tahlil_boshla', 't2_sozlama_saqla', 't2_tizim_amal', 't2_xato_yoz', 't2_kirish_amal'].sort();
