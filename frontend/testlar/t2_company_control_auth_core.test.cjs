/* T2-COMPANY-CONTROL-AUTH-CORE-001: source-only regression oracle.
...
must('platform va membership truth ajralgan', /create table if not exists public\.t2_platforma_rol/.test(migration) && /public\.t2_azolik/.test(migration));
