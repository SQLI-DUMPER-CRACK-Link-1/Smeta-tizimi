...
const context={String,Number,Array,Object,RegExp,_t2Rpc:()=>{rpcCalls++;},_t2Get:()=>[],DriveApp:{}};
vm.createContext(context); vm.runInContext(src,context);
const denied=context.apiT2LoyihaStorageProvision({companyId:1,projectId:2,operationId:'11111111-1111-4111-8111-111111111111'});
assert.strictEqual(denied.ok,false); assert.strictEqual(denied.code,'PROJECT_CONTEXT_REQUIRED'); assert.strictEqual(rpcCalls,0);
console.log('  ✅ behavioral missing actor fails before project provisioning');
