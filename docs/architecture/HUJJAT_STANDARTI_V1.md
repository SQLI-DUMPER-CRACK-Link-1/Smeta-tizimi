...
| Сличительная ведомость | `slichitelniy-vedomost.ts` | noldan (DOC-14/TPL-08, ichki nazorat) | ПО СМЕТЕ (кол-во, цена, сумма), ФАКТИЧЕСКИ ВЫПОЛНЕНО, ПРИНЯТО ПО АКТАМ Ф-2, ОТКЛОНЕНИЕ (ФАКТ − СМЕТА), Примечание (доп. работа / замена / исключено); "faqat farqi borlar" rejimi | ЗАКАЗЧИК, ПОДРЯДЧИК, ТЕХНАДЗОР, СОСТАВИЛ | A4 landshaft |
