-- ROLLBACK T2_SIGNAL_QATOR_BOSQICHLI_V1 — 20261101091000 dagi trigger funksiyasi (to'liq obyekt refresh).
begin;
...
drop function if exists public.t2_signal_obyekt_yengil(bigint,bigint);
drop function if exists public.t2_signal_qator_yangila(bigint,bigint,bigint,text,text,numeric,text,numeric,boolean);
