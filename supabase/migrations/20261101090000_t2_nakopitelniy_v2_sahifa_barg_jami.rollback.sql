-- ROLLBACK T2_NAKOPITELNIY_V2 — v1 asl tanasi (20261011100000) qaytadi, v2 o'chiriladi.
begin;
...
drop function if exists public.t2_nakopitelniy_v2(bigint,bigint,date,integer,boolean,integer);
commit;
