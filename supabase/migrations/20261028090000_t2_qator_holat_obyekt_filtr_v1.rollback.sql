-- ROLLBACK T2_QATOR_HOLAT_OBYEKT_FILTR_V1: asl view (CTE materialize, ota filtri yo'q) — semantika bir xil, faqat sekin.
...
with direct as (
  ...
  from direct d
    left join direct parent on parent.id = d.ota_id
)
