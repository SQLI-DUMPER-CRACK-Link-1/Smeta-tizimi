-- ROLLBACK T2_OZGARISH_TASDIQLASH_SIGNAL_BIR_MARTA — asl trigger funksiyasi, v2 o'chiriladi.
-- (Gateway /api/hujjat-nazorat ozgarish-tasdiqlash ni v1 ga qaytarish kerak.)
begin;
...
drop function if exists public.t2_smeta_ozgarish_tasdiqlash_v2(bigint,bigint,integer,uuid);
